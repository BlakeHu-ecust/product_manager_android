package com.product.productmanager.scanner;
...
import com.product.productmanager.scanner.camera.CameraManager;
import com.product.productmanager.scanner.common.BitmapUtils;
import com.product.productmanager.scanner.decode.BitmapDecoder;
import com.product.productmanager.scanner.decode.CaptureActivityHandler;
import com.product.productmanager.scanner.event.Event;
import com.product.productmanager.scanner.view.ViewfinderView;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case PARSE_BARCODE_SUC: // 解析图片成功
                    //ToolClass.showMessage("解析成功，结果为：" + msg.obj,CaptureActivity.this);
                    expressNo = msg.obj.toString();
                    EventBus.getDefault()
                            .post(Event.NET_SCANNING_SUCCESS);
                    break;

                case PARSE_BARCODE_FAIL:// 解析图片失败
                    //UiUtils.showToast("解析图片失败");
                    break;
...
//        findViewById(R.id.capture_scan_photo).setOnClickListener(this);
        TextView tvHint = (TextView) findViewById(R.id.capture_top_hint);
        tvHint.setText(Html.fromHtml("将二维码置于取景框内<br/>系统会自动扫描"));
    }
    ...
    private class Task implements Runnable {
        ...
        private Task(ProgressDialog progressDialog) {
